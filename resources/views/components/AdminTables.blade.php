                            ...
                            <tr>
                                <td>
                                    <div class="d-flex px-2">
                                        <div>
                                            <img src="{{ asset($dataArticel['img_artikel']) }}" class="avatar avatar-sm rounded-circle me-2" alt="spotify">
                                        </div>
                                        <div class="my-auto">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{route('category.newcategory')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <form action="{{route('admin.newarticle')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">subheding</label>
                                <input id="sub_heading" type="hidden" name="sub_heading">
                                <trix-editor input="sub_heading"></trix-editor>
                            </div>

                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">isi article</label>
