...
Route::post('/addartikel',[Pages::class,'Addkomentar'])->name('komentar');
Route::middleware(['auth', 'checkRole:admin'])->group(function () {
    ...
    Route::post('/articleUpd', [ArtikelsController::class, "update"])->name("article.upd");
...
Route::get('/test-image', function () {
    return asset('storage/images/qZWsvCKdwD9Frg5D7CLlKBsMlPkwDJpnSfth1cex.png');
});
